...
export function PublicAuctionAdminConsole({ event, lots, horses, factors, reviews, rounds, bids, owners, settlements, rollbackRequests }: PublicAuctionAdminConsoleProps) {
  ...
  return <main className="page-wrap">
    ...
    <GMSectionNav items={[{ href: "#event-status", label: "Event 状态" }, { count: lots.length, href: "#lot-management", label: "Lot 管理" }, { href: "#lot-management", label: "主持控制" }, { count: rollbackRequests.filter((request) => request.status === "PENDING_CONFIRMATION").length, href: "#lot-management", label: "结算与回滚" }]} />
